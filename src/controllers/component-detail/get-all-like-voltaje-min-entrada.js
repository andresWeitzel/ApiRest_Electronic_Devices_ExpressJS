...
//Services
const {
  getAllComponentDetailLikeVoltajeMinEntradaService,
} = require('../../services/component-detail/get-all-like-voltaje-min-entrada');
//Enums
...
const GET_ALL_COMPONENT_DETAIL_ERROR_DETAIL =
  'ERROR in getAllComponentDetailLikeVoltajeMinEntradaController() function.';
const GET_ALL_COMPONENT_DETAIL_BAD_REQUEST_DETAIL =
  'Bad request, could not get component details with the requested minimum input voltage.';
const GET_ALL_COMPONENT_DETAIL_NOT_FOUND_DETAIL =
  'No component details found with the specified minimum input voltage.';
//Vars
let msgResponse;
let msgLog;

/**
 * @description get all component details based on minimum input voltage from the database
 * @param {any} req any type
 * @param {any} res any type
 * @returns a json object with the transaction performed
 * @example
 */
const getAllComponentDetailLikeVoltajeMinEntradaController = async (req, res) => {
  try {
    msgResponse = null;
    msgLog = null;

    componentDetailList = await getAllComponentDetailLikeVoltajeMinEntradaService(req);
