...
} = require('../../services/component-detail/get-all-like-voltaje-recomendado');
//Enums
...
const GET_ALL_COMPONENT_DETAIL_ERROR_DETAIL =
  'ERROR in getAllComponentDetailLikeVoltajeRecomendadoController() function.';
const GET_ALL_COMPONENT_DETAIL_BAD_REQUEST_DETAIL =
  'Bad request, could not get component details with the requested recommended voltage.';
const GET_ALL_COMPONENT_DETAIL_NOT_FOUND_DETAIL =
  'No component details found with the specified recommended voltage.';
//Vars
let msgResponse;
let msgLog;

/**
 * @description get all component details based on recommended voltage from the database
 * @param {any} req any type
 * @param {any} res any type
 * @returns a json object with the transaction performed
 * @example
 */
const getAllComponentDetailLikeVoltajeRecomendadoController = async (req, res) => {
  try {
    msgResponse = null;
    msgLog = null;

    componentDetailList = await getAllComponentDetailLikeVoltajeRecomendadoService(req);
