...
const GET_ALL_COMPONENT_ERROR_DETAIL =
  'ERROR in getAllComponentLikeStockMinMaxController() function. Caused by  ';
const GET_ALL_COMPONENT_BAD_REQUEST_DETAIL =
  'Bad request, could not get all paginated list components according to the min and max stock.';
const GET_ALL_COMPONENT_NOT_FOUND_DETAIL =
  'No items found according to the min and max stock.';
let msgResponse;
let msgLog;
