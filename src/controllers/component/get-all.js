...
//Services
const { getAllComponentService } = require('../../services/component/get-all');
//Enums
...
const GET_ALL_COMPONENT_ERROR_DETAIL =
  'ERROR in getAllComponentController() function.';
const GET_ALL_COMPONENT_BAD_REQUEST_DETAIL =
  'Bad request, failed to obtain paginated component list.';
