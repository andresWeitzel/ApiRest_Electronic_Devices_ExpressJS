...
} = require('../../services/component/get-all-like-code');
//Enums
...
const GET_ALL_COMPONENT_ERROR_DETAIL =
  'ERROR in getAllComponentLikeCodeController() function. Caused by  ';
const GET_ALL_COMPONENT_BAD_REQUEST_DETAIL =
  'Bad request, could not get all paginated list components according to the code.';
const GET_ALL_COMPONENT_NOT_FOUND_DETAIL =
  'No items found according to the code.';
let msgResponse;
let msgLog;
