...
//Services
const {
  getAllComponentWithElectronicCapacitorService,
} = require('../../services/component/get-all-with-electronic-capacitor');
//Enums
...
const GET_ALL_COMPONENT_ERROR_DETAIL = 'ERROR in getAllWithElectronicCapacitorComponentController() function.';
const GET_ALL_COMPONENT_BAD_REQUEST_DETAIL = 'Bad request, failed to get all paginated components list and electronic_capacitor according to all attributes.';
const GET_ALL_COMPONENT_NOT_FOUND_DETAIL = 'No items found according to the electronic capacitor model.';
...
/**
 * @description get all paginated components list with details for electronic capacitor from the database
 * @param {any} req any type
 * @param {any} res any type
 * @returns a json object with the transaction performed
 * @example
 */
const getAllWithElectronicCapacitorComponentController = async (req, res) => {
  try {
    msgResponse = null;
    msgLog = null;
    componentList = await getAllComponentWithElectronicCapacitorService(req);
