...
const GET_ALL_MOSFET_TRANSISTOR_ERROR_DETAIL =
  'Error in getAllMosfetTransistorLikeVoltajeDrenajeFuenteService() function.';
//status
...
/**
 * @description get all paginated mosfet transistors list according to its voltaje_drenaje_fuente from the database
 * @param {any} req any type
 * @param {any} res any type
 * @returns a json object with the transaction performed
 * @example
 */
const getAllMosfetTransistorLikeVoltajeDrenajeFuenteService = async (req) => {
  try {
    ...
    if (params != (null && undefined)) {
      voltajeDrenajeFuenteParam = params.voltajeDrenajeFuente ? params.voltajeDrenajeFuente : voltajeDrenajeFuenteParam;
    }
    //-- end with params  ---
      ...
      await MosfetTransistor.findAll({
        ...
        where: {
          voltaje_drenaje_fuente: {
            [Op.iLike]: `%${voltajeDrenajeFuenteParam}%`,
          },
        },
        limit: pageSizeNro,
        offset: pageNro,
