...
const GET_ALL_MOSFET_TRANSISTOR_ERROR_DETAIL =
  'Error in getAllMosfetTransistorLikeConductDrenajeSustratoService() function.';
//status
...
/**
 * @description get all paginated mosfet transistors list according to its conduct_drenaje_sustrato from the database
 * @param {any} req any type
 * @param {any} res any type
 * @returns a json object with the transaction performed
 * @example
 */
const getAllMosfetTransistorLikeConductDrenajeSustratoService = async (req) => {
  try {
    ...
    if (params != (null && undefined)) {
      conductDrenajeSustratoParam = params.conductDrenajeSustrato ? params.conductDrenajeSustrato : conductDrenajeSustratoParam;
    }
    //-- end with params  ---
      ...
      await MosfetTransistor.findAll({
        ...
        where: {
          conduct_drenaje_sustrato: {
            [Op.iLike]: `%${conductDrenajeSustratoParam}%`,
          },
        },
        limit: pageSizeNro,
        offset: pageNro,
