...
const GET_ALL_MOSFET_TRANSISTOR_ERROR_DETAIL =
  'Error in getAllMosfetTransistorLikeTipoService() function.';
//status
...
/**
 * @description get all paginated mosfet transistors list according to its tipo from the database
 * @param {any} req any type
 * @param {any} res any type
 * @returns a json object with the transaction performed
 * @example
 */
const getAllMosfetTransistorLikeTipoService = async (req) => {
  try {
