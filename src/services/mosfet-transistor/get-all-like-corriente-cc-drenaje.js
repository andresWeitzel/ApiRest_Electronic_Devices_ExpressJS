...
const GET_ALL_MOSFET_TRANSISTOR_ERROR_DETAIL =
  'Error in getAllMosfetTransistorLikeCorrienteCcDrenajeService() function.';
//status
...
/**
 * @description get all paginated mosfet transistors list according to its corriente_cc_drenaje from the database
 * @param {any} req any type
 * @param {any} res any type
 * @returns a json object with the transaction performed
 * @example
 */
const getAllMosfetTransistorLikeCorrienteCcDrenajeService = async (req) => {
  try {
    ...
    if (params != (null && undefined)) {
      corrienteCcDrenajeParam = params.corrienteCcDrenaje ? params.corrienteCcDrenaje : corrienteCcDrenajeParam;
    }
    //-- end with params  ---
      ...
      await MosfetTransistor.findAll({
        ...
        where: {
          corriente_cc_drenaje: {
            [Op.iLike]: `%${corrienteCcDrenajeParam}%`,
          },
        },
        limit: pageSizeNro,
        offset: pageNro,
