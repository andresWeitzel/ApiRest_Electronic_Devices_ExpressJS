...
const GET_ALL_COMPONENT_DETAIL_ERROR_DETAIL =
  'Error in getAllComponentDetailLikePesoService() function.';
//status
...
/**
 * @description get all paginated component details list according to its weight from the database
 * @param {any} req any type
 * @param {any} res any type
 * @returns a json object with the transaction performed
 * @example
 */
const getAllComponentDetailLikePesoService = async (req) => {
  try {
    ...
    if (params != (null && undefined)) {
      pesoParam = params.peso ? params.peso : pesoParam;
    }
    //-- end with params  ---
