...
const GET_ALL_COMPONENT_DETAIL_ERROR_DETAIL =
  'Error in getAllComponentDetailLikeHojaDatosService() function.';
//status
...
/**
 * @description get all paginated component details list according to its data sheet from the database
 * @param {any} req any type
 * @param {any} res any type
 * @returns a json object with the transaction performed
 * @example
 */
const getAllComponentDetailLikeHojaDatosService = async (req, res) => {
  try {
    ...
    if (params != (null && undefined)) {
      hojaDatosParam = params.hojaDatos ? params.hojaDatos : hojaDatosParam;
    }
    //-- end with params  ---
