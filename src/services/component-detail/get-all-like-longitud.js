...
const GET_ALL_COMPONENT_DETAIL_ERROR_DETAIL =
  'Error in getAllComponentDetailLikeLongitudService() function.';
//status
...
/**
 * @description get all paginated component details list according to its length from the database
 * @param {any} req any type
 * @param {any} res any type
 * @returns a json object with the transaction performed
 * @example
 */
const getAllComponentDetailLikeLongitudService = async (req, res) => {
  try {
    ...
    if (params != (null && undefined)) {
      longitudParam = params.longitud ? params.longitud : longitudParam;
    }
    //-- end with params  ---
