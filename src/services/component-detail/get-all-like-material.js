...
const GET_ALL_COMPONENT_DETAIL_ERROR_DETAIL =
  'Error in getAllComponentDetailLikeMaterialService() function.';
//status
...
/**
 * @description get all paginated component details list according to its material from the database
 * @param {any} req any type
 * @param {any} res any type
 * @returns a json object with the transaction performed
 * @example
 */
const getAllComponentDetailLikeMaterialService = async (req) => {
  try {
    ...
    if (params != (null && undefined)) {
      materialParam = params.material ? params.material : materialParam;
    }
    //-- end with params  ---
