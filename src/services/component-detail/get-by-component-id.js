...
const GET_BY_COMPONENT_ID_COMPONENT_DETAIL_ERROR_DETAIL =
  'Error in getComponentDetailByComponentIdService() function.';
//status
...
/**
 * @description get a component detail according to component identifier from the database
 * @param {any} req any type
 * @param {any} res any type
 * @returns a json object with the transaction performed
 * @example
 */
const getComponentDetailByComponentIdService = async (req, res) => {
  try {
