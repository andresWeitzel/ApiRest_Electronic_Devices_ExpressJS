...
const GET_ALL_BIPOLAR_TRANSISTOR_ERROR_DETAIL =
  'Error in getAllBipolarTransistorLikeTipoService() function.';
//status
...
/**
 * @description get all paginated bipolar transistors list according to its tipo from the database
 * @param {any} req any type
 * @param {any} res any type
 * @returns a json object with the transaction performed
 * @example
 */
const getAllBipolarTransistorLikeTipoService = async (req) => {
  try {
