...
const GET_ALL_LIKE_VOLTAJE_EMIS_BASE_BIPOLAR_TRANSISTOR_ERROR_DETAIL =
  'Error in getAllBipolarTransistorLikeVoltajeEmisBaseService() function.';
//status
...
/**
 * @description get bipolar transistors according to voltaje_emis_base from the database
 * @param {any} req any type
 * @param {any} res any type
 * @returns a json object with the transaction performed
 * @example
 */
const getAllBipolarTransistorLikeVoltajeEmisBaseService = async (req) => {
  try {
    ...
    if (params != (null && undefined)) {
      voltajeEmisBaseParam = params.voltajeEmisBase ? params.voltajeEmisBase : null;
    }
    //-- end with params  ---
