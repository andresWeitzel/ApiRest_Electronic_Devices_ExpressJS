...
const GET_ALL_ELECTROLYTIC_CAPACITOR_ERROR_DETAIL =
  'Error in getAllElectrolyticCapacitorLikeToleranciaService() function.';
//status
...
/**
 * @description get all paginated electrolytic capacitors list according to its tolerancia from the database
 * @param {any} req any type
 * @param {any} res any type
 * @returns a json object with the transaction performed
 * @example
 */
const getAllElectrolyticCapacitorLikeToleranciaService = async (req) => {
  try {
    ...
    if (params != (null && undefined)) {
      toleranciaParam = params.tolerancia ? params.tolerancia : toleranciaParam;
    }
    //-- end with params  ---
