...
const GET_ALL_ELECTROLYTIC_CAPACITOR_ERROR_DETAIL =
  'Error in getAllElectrolyticCapacitorLikeRangoTemperaturaService() function.';
//status
...
/**
 * @description get all paginated electrolytic capacitors list according to its rango_temperatura from the database
 * @param {any} req any type
 * @param {any} res any type
 * @returns a json object with the transaction performed
 * @example
 */
const getAllElectrolyticCapacitorLikeRangoTemperaturaService = async (req) => {
  try {
    ...
    if (params != (null && undefined)) {
      rangoTemperaturaParam = params.rangoTemperatura ? params.rangoTemperatura : rangoTemperaturaParam;
    }
    //-- end with params  ---
