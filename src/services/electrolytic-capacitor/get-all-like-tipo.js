...
const GET_ALL_ELECTROLYTIC_CAPACITOR_ERROR_DETAIL =
  'Error in getAllElectrolyticCapacitorLikeTipoService() function.';
//status
...
/**
 * @description get all paginated electrolytic capacitors list according to its tipo from the database
 * @param {any} req any type
 * @param {any} res any type
 * @returns a json object with the transaction performed
 * @example
 */
const getAllElectrolyticCapacitorLikeTipoService = async (req) => {
  try {
    ...
    if (params != (null && undefined)) {
      tipoParam = params.tipo ? params.tipo : tipoParam;
    }
    //-- end with params  ---
