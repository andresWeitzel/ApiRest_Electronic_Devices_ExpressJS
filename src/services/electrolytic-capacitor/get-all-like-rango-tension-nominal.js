...
const GET_ALL_ELECTROLYTIC_CAPACITOR_ERROR_DETAIL =
  'Error in getAllElectrolyticCapacitorLikeRangoTensionNominalService() function.';
//status
...
/**
 * @description get all paginated electrolytic capacitors list according to its rango_tension_nominal from the database
 * @param {any} req any type
 * @param {any} res any type
 * @returns a json object with the transaction performed
 * @example
 */
const getAllElectrolyticCapacitorLikeRangoTensionNominalService = async (req) => {
  try {
    ...
    if (params != (null && undefined)) {
      rangoTensionNominalParam = params.rangoTensionNominal ? params.rangoTensionNominal : rangoTensionNominalParam;
    }
    //-- end with params  ---
